...
class EspeciesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let predicate = NSPredicate(format: "tipoEs == %@", tipo!)
    ...
    */
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = UIImage(data: especie.imagen4)
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "detallesEspecie"{
            let v = segue.destinationViewController as! DetallesViewController
            
            let indexpath = self.tableView.indexPathForSelectedRow()
            let row = indexpath?.row
            
            v.nombreCientificoSegue = especies[row!].nombreCientifico
        }
    }
